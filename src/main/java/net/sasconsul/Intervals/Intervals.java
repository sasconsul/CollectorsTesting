...
public class Intervals {
    ...
    public boolean intersects(Interval that) {
        if (this.max < that.end) return false;
        return !(that.end < this.min);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.min == that.start && this.max == that.end;
    }
    ...
    static void main(String[] args) {
        ...
        intervals[0] = new Interval(15, 33);
        intervals[1] = new Interval(45, 60);
        intervals[2] = new Interval(20, 70);
        intervals[3] = new Interval(46, 55);
